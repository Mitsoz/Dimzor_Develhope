...
df['firstltr'] = df['airline'].str[0]
airline_firstletter=df.groupby('firstltr').mean()['incidents_85_99']
airline_firstletter = airline_firstletter.to_frame()
airline_firstletter
airline_firstletter['firstltr'] = airline_firstletter['firstltr'].apply(str.lower())
